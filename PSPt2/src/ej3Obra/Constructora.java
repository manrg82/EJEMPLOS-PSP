...
public class Constructora {
    ...
    public static void main(String[] args) {
        ...
        Obra obra1 = new Obra(almacen, "Obra1", 200, 4000);
        Obra obra2 = new Obra(almacen, "Obra2", 400, 2000);
        ...
        System.out.println("Stock inicial: 0. Capacidad máxima: 6000.");
        hiloFabrica.start();
        hiloObra1.start();
        hiloObra2.start();
        ...
        try {
            ...
            System.out.println("\nCONSTRUCTORA: Las obras trabajarán por 2 minutos...\n");
            ...
            hiloObra1.interrupt();
            hiloObra2.interrupt();
            System.out.println("CONSTRUCTORA: Esperando a que la fábrica y las obras finalicen...");
